...
final class ListsRepository extends Repository
{
    ...
    public function countPublicLists(): int
    {
    ...
    public function deleteUserList(int $userId, int $listId): bool
    {
        $query = $this->connection()->prepare(
            'DELETE FROM lists
             WHERE id = :list_id
    ...
    public function countVisibleUserLists(int $userId, int $currentUserId): int
    {
        $query = $this->connection()->prepare(
            'SELECT COUNT(*)
             FROM lists
    ...
    public function getVisibleUserLists(int $userId, int $currentUserId, int $limit = 10): array
    {
        $query = $this->connection()->prepare(
            'SELECT
                l.id,
